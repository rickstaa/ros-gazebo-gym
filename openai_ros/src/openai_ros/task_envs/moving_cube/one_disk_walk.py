...
class MovingCubeOneDiskWalkEnv(cube_single_disk_env.CubeSingleDiskEnv):
    def __init__(self):
        ...
        ROSLauncher(
            rospackage_name="moving_cube_description",
    ...
    def _set_action(self, action):
        ...
        self.roll_turn_speed = numpy.clip(
            self.roll_turn_speed,
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            reward_y_axis_angle = (
                -1 * abs(sin_yaw_angle) * self.y_axis_angle_reward_weight
            )
