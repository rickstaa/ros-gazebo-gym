...
class FetchPickAndPlaceEnv(fetchsimple_env.FetchSimpleEnv, utils.EzPickle):
    def __init__(self):
        ...
        super(FetchPickAndPlaceEnv, self).__init__(workspace_path)
        ...
        observations_high_range = np.array(self.upper_array_observations)
        observations_low_range = np.array(self.lower_array_observations)
    ...
    def get_params(self):
        ...
        self.goal_pos = [
            goal_pos_dict["elbow_flex_joint"],
    ...
    def _is_done(self, observations):
        ...
        done = np.allclose(a=observations, b=self.goal_pos, atol=0.2)
