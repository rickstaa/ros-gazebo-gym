"""Class used for displaying a marker for the cube object in rviz. This class overloads
the :obj:`openai_ros.common.markers.TargetMarker` class in order to pre-initialize some
of its attributes. Most importantly, a pose offset was applied to align the marker frame
with the object frame.
"""
...
class CubeMarker(TargetMarker):
    """Class used to create an rviz marker for the grasping cube.
