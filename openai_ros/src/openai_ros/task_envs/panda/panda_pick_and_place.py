...
from openai_ros.common.functions import get_orientation_euler, normalize_quaternion
from openai_ros.exceptions import SetModelStateError, SpawnModelError
from openai_ros.task_envs.panda import PandaReachEnv
from openai_ros.task_envs.panda.markers import CubeMarker, FrameOriginMarker
        ...
        **kwargs,
        ...
        Args:
            ...
            *args: Arguments passed to the
                :obj:`~openai_ros.task_envs.panda.PandaReachEnv` super class.
        ...
        self._object_marker_pub = rospy.Publisher(
            "/openai_ros/object", CubeMarker, queue_size=1, latch=True
        )
        ...
        self._object_frame_marker_pub = rospy.Publisher(
            "/openai_ros/object_frame", CubeMarker, queue_size=1, latch=True
        )
