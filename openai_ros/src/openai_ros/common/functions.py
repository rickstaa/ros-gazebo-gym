...
from openai_ros.common.euler_angles import EulerAngles
...
def model_state_msg_2_link_state_dict(link_state_msgs):
    """Converts the a `gazebo_msgs/ModelState <https://docs.ros.org/en/jade/api/gazebo_msgs/html/msg/ModelState.html>`
