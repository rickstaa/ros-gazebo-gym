...
class HusarionEnv(RobotGazeboEnv):
    ...
    def __init__(self, workspace_path):
        ...
        Args:
            workspace_path (str, optional): The path of the workspace in which the
                husarion_env_gazebo package should be found. Defaults to ``None``.
        """
        ...
        # RobotGazeboEnv
        super(HusarionEnv, self).__init__(
    ...
    def wait_until_twist_achieved(
        self, cmd_vel_value, epsilon, update_rate, angular_speed_noise=0.005
    ):
        """
        ...
        Returns:
            delta_time (float): The time that has passed.
        """
    ...
    def check_angular_speed_dir(self, angular_speed, angular_speed_noise):
        ...
        rospy.logdebug(f"Angular speed value: {angular_speed_is}")
