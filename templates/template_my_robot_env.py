"""Template file used that can be used to create a new Robot environment. It contains
a python class that specifies the robot to use on the task. It provides the complete
integration between the Gazebo simulation of the robot and the OpenAI algorithm
environments, so obtaining **SENSOR** information from the robot or sending **ACTIONS**
to it are ROS transparent to the OpenAI algorithms and to you, the developer. For more
information see the `ros_gazebo_gym <https://rickstaa.dev/ros-gazebo-gym>`_
documentation.
